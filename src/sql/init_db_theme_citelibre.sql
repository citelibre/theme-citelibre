...
INSERT INTO `core_datastore` (`entity_key`, `entity_value`) VALUES
	...
	('themecitelibre.site_property.Url.accessibilityURL', 'jsp/site/Portal.jsp?page=htmlpage&amp,htmlpage=1'),
	...
	('themecitelibre.site_property.Url.cookieURL', 'jsp/site/Portal.jsp?page=htmlpage&amp,htmlpage=1'),
	...
	('themecitelibre.site_property.xss.xssMsg', 'Les caract\\u00e8res &#60, &#62, &#35, et &#34,  &amp, sont interdits dans le contenu de votre message.'),
	('themecitelibre.site_property.Url.keycloack', 'http://localhost:8080/rendezvous/servlet/plugins/oauth2/callback?data_client=authData');
