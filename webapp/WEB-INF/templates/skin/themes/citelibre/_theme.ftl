...
<link href="${commonsSiteSharedPath}${commonsSiteCssPath}tabler-icons.min.css?version=${commonsGlobalThemeVersion}" rel="stylesheet">
<!-- Site CSS include                  -->
...
<script src="${commonsSharedThemePath}${commonsSiteJsPath}shared.js?version=${commonsGlobalThemeVersion}" blocking="render"></script>
<!-- Site CSS include                  -->
