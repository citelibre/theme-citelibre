...
<section class="hero">
  <div class="container hero__grid">
    <div>
      <span class="hero__tag">Propulsé par Lutèce · 100% open-source</span>
      <h1>Les services numériques prêts à déployer pour votre collectivité</h1>
      <p>Démarches, rendez-vous, identité, contact — des solutions assemblées, testées, conteneurisées. Déployez en un mois, pas en six.</p>
      <div class="hero__cta">
