...
<footer role="contentinfo"<#if params !=''> ${params!}</#if>>
  <div class="container">
     <div class="foot__grid">
        <div>
          <a href="${logoUrl}"><img alt="${logoAlt}" style="height:44px;margin-bottom:16px;filter:brightness(0) invert(1);" src="${logoFooter}" /></a>
        ...
        <div><h3 class="h4">Packs</h3><ul class="footer-menu list-unstyled" aria-label="#i18n{portal.theme.footerInfo}" ><li><a>Service'EZ</a></li><li><a>Rendez-vous</a></li><li><a>Ident'EZ</a></li><li><a>Contact'EZ</a></li></ul></div>
        <div><h3 class="h4">Ressources</h3><ul class="footer-menu list-unstyled" aria-label="#i18n{portal.theme.footerInfo}" ><li><a>Documentation</a></li><li><a>GitHub</a></li><li><a>Wiki Lutèce</a></li><li><a>Newsletter</a></li></ul></div>
        <div><h3 class="h4">Legal</h3><ul class="footer-menu list-unstyled" aria-label="#i18n{portal.theme.footerInfo}" ><@_footerMenu /></ul></div>
      </div>
